...
export function GlobalParameterConfigurationPage() {
  ...
  useEffect(() => {
    ...
    if (state.variableLibraryConfig) {
      ...
      setDescription('Global parameters migrated from Azure Data Factory');
    ...
    <div className="space-y-6">
      ...
      <Alert className="border-blue-200 bg-blue-50">
        ...
        <AlertDescription className="text-gray-800">
          <strong>What's happening:</strong> ADF Global Parameters will be migrated to a Fabric Variable Library. 
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g., DataFactory_GlobalParameters"
              disabled={isDeployed || isDeploying}
              className="mt-1"
            />
            <p className="text-sm text-gray-600 mt-1">
              Must be unique in the workspace. Only letters, numbers, spaces, hyphens, and underscores allowed.
            </p>
          </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-gray-900">ADF Type</TableHead>
